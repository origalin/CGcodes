...
var VSHADER_SOURCE = 
  ...
  'void main() {\n' +
	'  float Aconst = 0.3;\n' +
	'  float Bconst = 2.0*radians(180.0);\n' +
	'  vec4 m_Position = vec4(a_Position.x * (1.0 + Aconst*sin(Bconst*a_Position.z+C)), a_Position.y * (1.0 + Aconst*sin(Bconst*a_Position.z+C)), a_Position.z, a_Position.w);\n' +
  '  gl_Position = u_ModelMatrix * m_Position;\n' +
  '  gl_PointSize = 10.0;\n' +
  '  v_Color = a_Color;\n' +
  '}\n';
